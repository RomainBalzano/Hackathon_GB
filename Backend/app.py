...
def find_similar_images(database_path, mobbin_names):
    ...
    cursor.execute("SELECT * FROM image_mobbin WHERE nom IN ({})".format(",".join(["?" for _ in mobbin_names])), mobbin_names)
    ...
    return [gb_image[0][1] for gb_image in top_3_gb_images], None
